...
return_type aes_set_key_( const unsigned char key[],
                         length_type keylen,
                         aes_context ctx[1] );
#endif
...
return_type aes_encrypt_( const unsigned char in[N_BLOCK],
                         unsigned char out[N_BLOCK],
                         const aes_context ctx[1] );

return_type aes_cbc_encrypt_( const unsigned char *in,
                         unsigned char *out,
                         int n_block,
...
return_type aes_decrypt_( const unsigned char in[N_BLOCK],
                         unsigned char out[N_BLOCK],
                         const aes_context ctx[1] );

return_type aes_cbc_decrypt_( const unsigned char *in,
                         unsigned char *out,
                         int n_block,
                         unsigned char iv[N_BLOCK],
                         const aes_context ctx[1] );
